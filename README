.. -*- mode: rst -*-
==========================================
 Keyboards for the Lingala language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Lingala language. The data and implementations
...
* http://giellatekno.uit.no/lindoc/index.html
* http://divvun.no/doc/tools/docu-lin-manual.html
...
The Lingala keyboard sources can be acquired using the `Giella SVN
